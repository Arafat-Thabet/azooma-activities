...
<li>
    ...
    <ul class="dropdown-menu multi-level">
        ...
        {{-- Customer --}}
        @if(Auth::guard('customer')->check()  && checkUserRole('customer'))
        <li>
        ...
        <li>
            <a class="dropdown-item" href="{{ route('eventmie.admin_profile') }}"><i class="fas fa-id-card"></i> @lang('eventmie-pro::em.profile')</a>
        </li>
        <li>
