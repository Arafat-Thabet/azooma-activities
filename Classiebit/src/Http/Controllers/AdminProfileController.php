...
class AdminProfileController extends Controller
{
    ...
    public function index($view = 'eventmie::profile.admin_profile', $extra = [])
    {
    ...
    public function updateAuthUser (Request $request)
    {
        ...
        return success_redirect($msg, route('eventmie.admin_profile'));
    ...
    public function updateAuthUserRole(Request $request)
    {
        ...
        $mail['action_url']     = route('eventmie.admin_profile');
        ...
        return redirect()->route('eventmie.admin_profile');
    }
